...
import '../../profile/views/badge_view.dart';
...
class ProfileLearningView
  ...
  @override
  State<ProfileLearningView> createState() =>
      _ProfileLearningViewState();
}

class _ProfileLearningViewState
    extends State<ProfileLearningView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title:
            const Text('Profil Pembelajaran'),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            hasData
                                ? '${controller.unlockedCount.value}/${controller.totalCount.value} reward terbuka'
                                : 'Lihat perjalanan XP dan koleksi sainsmu',
